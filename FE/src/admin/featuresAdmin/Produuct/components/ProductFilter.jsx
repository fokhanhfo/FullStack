...
function ProductFilter({ filter, onSubmit }) {
  ...
  const handleSubmit = async (values) => {
    ...
    const newValues = {
      ...
      category: values.category ? JSON.stringify(values.category) : null,
    };
  ...
  return (
    <>
      ...
      >
        ...
        <SelectFrom width="30%" name="category" label="Danh mục" form={form} options={categoryQuery.data.data} />
